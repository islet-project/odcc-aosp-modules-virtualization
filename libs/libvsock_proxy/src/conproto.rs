...
{
    /// Connection protocol command
    pub command: String,
    /// Server address (name or ip:port)
...
/// Receives a connection request from ratls-get client
...
/// Sends a connection response to ratls-get client
